unit Hefesto.Outbox.Tests;

{
  Testes unitários para o contrato IHefestoOutbox / IHefestoOutboxPoller.
...
type
  { Mock in-memory IHefestoOutbox para validação de contrato }
  ...
  TInMemoryOutbox = class(TInterfacedObject, IHefestoOutbox)
  private
  ...
  { Mock IHefestoOutboxPoller }
  TInMemoryOutboxPoller = class(TInterfacedObject, IHefestoOutboxPoller)
  private
    FPending: Integer;
    FStarted: Boolean;
    FStopped: Boolean;
