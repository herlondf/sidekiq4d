unit Sidekiq4D.Graph.Tests;

{
  Testes unitários para TSidekiqJobGraph.
...
type
  ...
  public
    ...
    [Test]
    [Category('Unit')]
    procedure Execute_Cycle_RaisesESidekiqGraphCycle;
...
begin
  Assert.IsTrue(TSidekiqJobGraph.New.Execute,
...
var
  LGraph: ISidekiqJobGraph;
begin
  LGraph := TSidekiqJobGraph.New
...
procedure TJobGraphTests.Execute_Cycle_RaisesESidekiqGraphCycle;
begin
  Assert.WillRaise(
    procedure
    begin
    ...
    ESidekiqGraphCycle,
    'Ciclo A→B→A deve levantar ESidekiqGraphCycle');
end;
...
begin
  Assert.WillRaise(
    ...
    ESidekiqGraphUnknownDependency,
    'Dependência de nó inexistente deve levantar ESidekiqGraphUnknownDependency');
end;
...
begin
  Assert.WillRaise(
    ...
    ESidekiqGraphDuplicateNode,
    'ID duplicado deve levantar ESidekiqGraphDuplicateNode');
end;
...
begin
  Assert.WillRaise(
    procedure
    begin
      TSidekiqJobGraph.New.DependsOn('parent');
    end,
    ESidekiqJobGraph,
