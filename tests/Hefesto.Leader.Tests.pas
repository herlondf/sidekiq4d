unit Hefesto.Leader.Tests;

{
  Testes unitários para THefestoLeaderElection.
...
type
  ...
  private
    ...
    FProvider: IHefestoLockProvider;
    FLeader: IHefestoLeaderElection;
  public
    [Setup]
    procedure Setup;
    [TearDown]
...
begin
  ...
  FProvider := THefestoInMemoryLockProvider.New(FStore);
  FLeader := THefestoLeaderElection.New(FProvider, 'test-leader', 30);
end;
...
var
  LLeader2: IHefestoLeaderElection;
  LResult1, LResult2: Boolean;
begin
  LLeader2 := THefestoLeaderElection.New(FProvider, 'test-leader', 30);
  try
