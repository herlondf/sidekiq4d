unit Hefesto.Batch.Tests;

{
  Testes unitários para THefestoBatchStateStore (IHefestoBatchService).
...
type
  ...
  private
    ...
    function MakeCallbackRequest(
      const AQueue, AAction: string): THefestoPublishRequest;
  public
    [Setup]
    procedure Setup;
...
begin
  ...
  FService := THefestoBatchStateStore.New(FStore);
end;
...
var
  LId: string;
  LCallbacks: TArray<THefestoPublishRequest>;
begin
...
var
  LId: string;
  LFirst, LSecond: TArray<THefestoPublishRequest>;
begin
